...
if (isset($_POST['hiddendata'])) {
    ...
    $sql = "UPDATE tb_produto SET nm_produto='$nomeProduto', vl_preco='$valorProduto', ds_produto='$descricaoProduto', qtd_produto='$qtdProduto', id_categoria='$categoriaProduto' WHERE cd_produto=$uniqueid";
    $result = mysqli_query($mysqli, $sql);
}
